...
AndroidDriver::AndroidDriver()
    : m_Cam( android::Camera::connect(0) ), m_CamListener( new HALCameraListener )
{
    LOGI("------------- Initializing Android camera...\n");
