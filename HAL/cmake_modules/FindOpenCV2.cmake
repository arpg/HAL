...
IF(NOT ANDROID AND OpenCV2_GPU_INCLUDE_DIR)
    LIST(APPEND OpenCV2_INCLUDE_DIRS ${OpenCV2_GPU_INCLUDE_DIR})
ENDIF()

if(OpenCV2_LEGACY_INCLUDE_DIR)
    LIST(APPEND OpenCV2_INCLUDE_DIRS ${OpenCV2_LEGACY_INCLUDE_DIR})
endif()
...
if(OpenCV2_LEGACY_LIBRARY)
    LIST(APPEND OpenCV2_LIBRARIES ${OpenCV2_LEGACY_LIBRARY})
endif()

IF(NOT ANDROID AND OpenCV2_GPU_LIBRARY)
